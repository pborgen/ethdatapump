...
class ExportTransactionsFromToAddress {
    ...
    export (start_block, end_block) {
        ...
        let start = async function() {
            ...
            var transactions = [];
            const base_path = '/home/paul/dev/eth_data_analyze_home_dir/temp_storage/long_term_storage/pre_processing/blocknumber_to_transactions/partitioned_by_block_number'
            let reader = await parquet.ParquetReader.openFile(base_path + '/part.0.parquet');
            ...
            for (let current_block_number = start_block; current_block_number <= end_block; current_block_number++) {
                ...
                batch.add(web3.eth.getTransaction.request, current_transaction_hash);
