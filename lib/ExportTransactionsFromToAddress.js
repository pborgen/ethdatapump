...
class ExportTransactionsFromToAddress2 {
    constructor() {
    ...
    export (block_number_with_transactions_full_path) {
        ...
        let counter = 0;
        let properties = PropertiesSingleton;
        ...
        let start = async function() {
            ...
            for (const blockNumberTransactionNumber of blockNumberTransactionNumberList) {
                ...
                let transactionHash = blockNumberTransactionNumber['transaction_hash'];
...
module.exports = ExportTransactionsFromToAddress2;