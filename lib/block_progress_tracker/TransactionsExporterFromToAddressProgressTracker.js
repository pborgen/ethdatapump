...
class TransactionsExporterFromToAddressProgressTracker extends ProgressTracker {
    ...
    updateState() {
        ...
        // Start - Creat a lock
        const lockDirectory = '/mnt/crypto/export/prod/lock';
        const lockFilePath = lockDirectory + '/FromToAddressProgressTracker';
        ...
        const release = lockfile.lockSync(lockFilePath, lockConfig);
        // End - Creat a lock
